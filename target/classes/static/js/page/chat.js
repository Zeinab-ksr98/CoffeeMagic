...
for (var i = 0; i < chats.length; i++) {
  ...
  $.chatCtrl('#mychatbox', {
    ...
    picture: (chats[i].position == 'left' ? 'assets/img/usersComponents/user-5.png' : 'assets/img/usersComponents/user-1.png'),
...
$("#chat-form").submit(function () {
  ...
  if (me.find('input').val().trim().length > 0) {
    $.chatCtrl('#mychatbox', {
      ...
      picture: 'assets/img/usersComponents/user-5.png',
    });
    me.find('input').val('');
  }
  return false;
